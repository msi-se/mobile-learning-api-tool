...
umgesetzt? (Frage nach Gesamtkonzept) (Slider: voll und ganz/überhaupt 
nicht)

- Verstehen Sie die Verbindung der Vorlesungsinhalte zu Ihrer möglichen professionellen Zukunft?
...
bei mir hat sich als erste Frage gestellt, ob die zu evaluierenden 
Veranstaltungen Pflichtveranstaltungen sind oder Wahl-Pflicht. Bei 
Pflichtveranstaltungen hätte ich keine Wahl, sondern müsste sie 
besuchen, auch wenn ich sie nicht sinnvoll fand. Das sollte bei den 
Antwortoptionen berücksichtigt werden (ob implizit oder explizit ist 
egal, aber es wäre als Hintergrund wichtig).

Ansonsten schreibe ich meine Kommentare direkt zu den jeweiligen Fragen 
dazu.
...
Am 28.02.2024 um 12:17 schrieb Tobias Toegel:
 Hallo Frau Dr. Landwehr,
 ...
 -> "Zufriedenheit" finde ich hier schwer zu erfassen. Wann ist man mit 
 den Inhalten der Vorlesung zufrieden? Zusätzliche Frage: einzelne 
 Vorlesung oder Vorlesungskonzept?
 
 Wäre es hier vielleicht besser, konkreter nachzufragen? z.B. wie folgt:
 ...
 -> hier wäre meine Nachfrage: Relevanz wofür? Für das gesamte Studium? 
 Als Baustein, um das Thema zu verstehen? Für den späteren Job?
 
 Dies ist eine sehr abstrakte Frage. Vielleicht müsste man hier etwas 
 nachjustieren.
 
 Vielleicht ginge hier auch z.B. Waren die Inhalte der heutigen 
 Veranstaltung nachvollziehbar erläutert/aufbereitet? (Slider: voll und 
 ganz/überhaupt nicht)
 
 Das haben Sie in der Form gar nicht abgefragt.
 
 ## Vorlesungsgeschwindigkeit
 Wie empfanden Sie die Geschwindigkeit der Vorlesung? (Slider)
 Beschriftung (links/rechts): zu langsam/zu schnell
 -> achten Sie hier wieder darauf, ob "heutige Veranstaltung" oder 
 gesamte Vorlesung gemeint ist.
 
 
 Jetzt kommen viele Volltext-Fragen. Diese sind für den/die Dozent*in 
 hilfreich, benötigen aber viel/deutlich mehr Zeit zum Ausfüllen - 
 insbesondere, wenn dies zum Abschluss einer/jeder Veranstaltung 
 stattfinden soll als kurzes (max. 5-minütiges) Feedback.
 ...
 -> Inhalte mit Wiederholungsbedarf wären für mich Inhalte, die man nicht 
 verstanden hat - klingt aber negativer.
 
 Vielleicht: Gibt es Inhalte, die nochmal genauer erläutert werden 
 sollten? (Das sagt auch, dass ich etwas nicht verstanden habe auf sehr 
 neutralem Niveau, außer die Veranstaltung gibt nur einen kurzen 
 Überblick über ein riesiges Themenspektrum und man möchte gern mehr zu 
 einem Thema erfahren.)
 ...
 Alternativ: Gibt es Ihrerseits weitere Fragen?
 ## Organisation
 Sind Sie mit der Organisation der Vorlesung zufrieden?
 Ja-Nein Frage
-> was ist die Organisation der Vorlesung? Die inhaltliche Struktur? Die 
Kommunikation, was ich wann für Leistungsnachweise erbringen muss? Ich 
wüsste so nicht, was ich hier antworten soll. Vielleicht auch nur als 
Semesterfeedback?
 ...
 -> Ich verstehe Ihre Frage. Das Problem ist, dass "sinnvoll" auch 
 beleidigend verstanden werden kann. Entweder hat ein Prof sich die 
 Veranstaltung ausgedacht, weil er sie so toll und sinnvoll findet oder 
 es ist ein Pflichtfach, das gehalten werden muss.
 
 Vielleicht eher eine Frage der Relevanz der Veranstaltung für die 
 professionelle Zukunft? Oder auch die Passung im Studiengang an sich?
 ...
 vorher schon gut in dem Thema war. Das ist aktuell hier nicht 
 abgebildet. Vielleicht eine Einschätzung der eigenen Kenntnisse vor und 
 nach dem Kurs als Referenz? Dann wäre dies besser abgebildet.
 ...
 Gibt es Inhalte mit Wiederholungsbedarf? (Volltext)
 (Wenn ja, welche?)
-> vielleicht auch in die Richtung: Gibt es Themen, die nicht 
ausreichend erläutert wurden?
...
-> gibt es konkrete Inhalte, die noch in die Vorlesung aufgenommen 
werden sollten? (positiver formuliert, weniger als Angriff auf den Prof)

-- 
Dr. Barbara Landwehr
Referentin Qualitätsmanagement
Bereich Lehre, Qualität und Digitale Transformation (Bereich LQD)
